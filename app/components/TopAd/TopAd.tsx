...
function TopAd() {
  return (
    <a
      href=""
      className="group flex justify-center z-50 relative items-center text-xs w-full py-2 px-5 text-balance stext-center tracking-tight leading-none font-semibold rounded-2xl transition transition-rounded | lg:text-sm | pointer-fine:hover:rounded-md text-grey-900 bg-mint"
    >
