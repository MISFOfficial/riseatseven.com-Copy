    ...
    <section className="w-full py-0" id="footer">
      <div className="w-full px-0">
        <div className="p-2 grid relative mt-8 lg:mt-0 js-footer">
          <div className="absolute top-0 left-0 w-full p-2 flex js-footer-background" style={{ height: "100%" }}>
            <div className="w-full h-full bg-grey-900 rounded-3xl"></div>
          </div>

          <div className="col-start-1 row-start-1 grid grid-cols-12 pt-14 pb-6 relative z-20 lg:py-10 px-4 md:px-7 gap-x-3 md:gap-x-5 gap-y-3 md:gap-y-7 js-footer-content" style={{ opacity: 1 }}>
            ...
            <div className="col-span-12 flex justify-between flex-col mt-10 items-end md:flex-row lg:items-center lg:mt-0 pt-8 border-t border-white/5">
              <div className="flex gap-x-2 gap-y-2 flex-wrap items-center md:gap-3">
                ...
                {bottom.links.map((link, i) => (
                  <React.Fragment key={i}>
                    <a href={link.href} className="text-white font-light leading-tight text-[10px] md:text-xs hover:underline transition-all">
                      {link.label}
                    </a>
              ...
              <div className="w-full mt-1 md:ml-auto md:text-right lg:mt-0 lg:w-auto">
                <a href="https://madebyshape.co.uk" target="_blank" rel="noopener noreferrer" className="text-white font-light leading-tight text-[10px] md:text-xs hover:underline transition-all">
                  {bottom.credit}
                </a>
              </div>
            </div>
