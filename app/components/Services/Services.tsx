  ...
  return (
    <section className="w-full pb-12 | xl:pb-24">
      <div className="w-full px-4 | md:px-7">
        ...
        {/* Header */}
        <div class="grid grid-cols-12 overflow-hidden | lg:pt-5 | gap-y-3 | md:gap-y-7 gap-x-3 | md:gap-x-5 mb-10">
          <div class="col-span-12">
            <div class="grid grid-cols-12 md:border-b md:border-grey-200 md:pb-5 gap-y-3 | md:gap-y-7 gap-x-3 | md:gap-x-5 items-center">
              <div class="col-span-11 md:col-span-9 flex items-center">
                <h2 className="inline-flex flex-wrap text-balance relative pointer-fine:pr-1 pointer-fine:pb-2 flex flex-row items-center text-left justify-start text-grey-900 text-6xl/0.9 | md:text-7xl/none | lg:text-7xl/none | 2xl:text-8xl/0.9 | 4xl:text-8.5xl/0.9 font-sans-primary font-medium tracking-tight">
                  ...
                  <div className="inline shrink-0 flex bg-black/5 relative overflow-hidden mr-4" style={{ borderRadius: "15%", width: "75px", height: "55px" }}>
                    <img src={servicesData.titleImage} alt="Services deco" className="w-full h-full object-cover" />
                  </div>
                  <span>Services</span>
                </h2>
              </div>
              <div class="col-span-12 | md:col-span-3 md:items-center md:justify-end hidden md:flex">
                <Link
          ...
          {servicesData.items.map((service, i) => (
            <div key={i} className="col-span-12 -my-px | md:col-span-6">
              <div className="group relative border-b border-grey-200">
                <Link href={service.link} className="grid grid-cols-1 relative z-10">
