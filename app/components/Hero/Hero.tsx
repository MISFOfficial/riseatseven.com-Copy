      ...
      <div className="w-full px-0">
        <div className="w-full h-screen-fix h-svh relative p-2">
          ...
          <div className="items-end justify-between absolute bottom-0 left-0 z-30 w-full p-7 flex">
            <div className="hidden flex-shrink-0 | md:inline max-w-sm">
            ...
            <div className="w-full text-center | md:text-right max-w-xs">
              <p className="text-sm font-sans-primary leading-normal text-pretty text-white mb-0!">
                <strong className="font-medium">{heroData.bottomText.right}</strong>
              </p>
            </div>
          </div>
            ...
            <div className="w-full h-full overflow-hidden grid bg-grey-900 rounded-3xl scale-105">
              ...
              <div className="col-start-1 row-start-1 z-20 relative flex justify-center items-center bg-grey-900/30">
                <div className="flex flex-col items-center">
                  ...
                  <div className="flex flex-col items-center justify-center mb-5">
                    ...
                    <div className="flex items-center gap-x-2">
                      ...
                      {heroData.badges.logos.map((logo, i) => (
                        <div key={i} className="w-12 aspect-20/9 relative">
                          <img src={logo} alt="Badge" className="w-full h-full object-contain" />
                        </div>
                      ))}
                      <svg viewBox="0 0 28 38" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-6 fill-current text-white">
                  ...
                  {/* Heading */}
                  <h1 className="inline-flex flex-wrap text-balance relative pointer-fine:pr-1 pointer-fine:pb-2 pointer-fine:mt-4 pointer-fine:-mb-3 flex flex-col text-center justify-center text-white text-6xl/0.9 | md:text-6xl/none | lg:text-7xl/0.9 | xl:text-8.5xl/0.9 | 4xl:text-9xl/0.9 font-sans-primary font-medium tracking-tight">
                    <div className="w-full" style={{ position: "relative", display: "block", textAlign: "center" }}>
                    ...
                    <div className="w-full" style={{ position: "relative", display: "block", textAlign: "center" }}>
                      <div className="flex flex-wrap relative pointer-fine:-mt-6 pointer-fine:pb-6 pointer-fine:overflow-hidden text-center justify-center">
                        ...
                        <div className="inline shrink-0 flex bg-black/10 relative overflow-hidden bg-black/5 mr-2 | pointer-fine:mr-0 | js-image-wrapper" style={{ marginRight: "10px", borderRadius: "15%", width: "68px", height: "auto" }}>
                          <div className="w-full h-full relative">
                            {randomImage && <img src={randomImage} className="w-full h-full object-cover absolute inset-0" alt="Random Hero" />}
                          </div>
                        </div>
