            ...
            <div className="w-full h-full overflow-hidden grid bg-grey-900 rounded-3xl scale-105">
              ...
              <div className="col-start-1 row-start-1 z-20 relative flex justify-center items-center bg-grey-900/30">
                <div className="flex flex-col items-center">
                  ...
                  {/* Heading */}
                  <h1 className="flex flex-wrap text-balance relative pointer-fine:pr-1 pointer-fine:pb-2 pointer-fine:mt-4 pointer-fine:-mb-3  flex-col text-center justify-center text-white text-6xl/0.9 | md:text-6xl/none | lg:text-7xl/0.9 | xl:text-8.5xl/0.9 | 4xl:text-9xl/0.9 font-sans-primary font-medium tracking-tight">
                    <div
                      className="w-full"
                      style={{
                        position: "relative",
                    ...
                    >
                      <div className="flex flex-wrap relative pointer-fine:-mt-6 pointer-fine:pb-6 pointer-fine:overflow-hidden text-center justify-center">
                        ...
                        {renderText(
                          heroData.heading.line2.split(" ").slice(1).join(" "),
                        )}
                      </div>
                    </div>
                  </h1>
