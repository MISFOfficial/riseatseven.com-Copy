  ...
  return (
    <AnimatePresence>
      {isOpen && (
        ...
        >
          <div className="w-full h-full bg-grey-900/80 rounded-3xl px-4 py-2.5 flex flex-col items-start justify-between overflow-y-auto shadow-2xl">
            <div className="w-full grid gap-y-10">
              {/* Header in Menu */}
              <div className="w-full flex items-center justify-between">
                <a href="/" className="w-32 inline-flex md:w-40 text-white">
                  <svg
                ...
                <button
                  onClick={onClose}
                  className="inline-flex items-center justify-center w-12 h-8 text-white group"
                >
